                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact__content">
                        ...
                        <div class="contact__form">
                            <h5>댓글 수정</h5>
                            <form action="${contextPath }/boardAdvance/qnaUpdateReply" method="post">
                            	
                                <input type="text" name="memberId" id="memberId" placeholder="아이디" value="${qnaReplyDTO.memberId }"  required="required" maxlength="15" readonly="readonly"/>
								...
								<p class="answer"></p>
                                <textarea rows="10" cols="50" name="content" required="required">${qnaReplyDTO.content }</textarea>
