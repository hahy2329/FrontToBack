...
<script>
	...
	function getBoardList(){
		...
		var url = "${contextPath}/boardAdvance/knowledgeList";
                ...
                <div class="col-lg-12">
                    ...
                    <h2>지식</h2>
                        <table>
                            ...
                            <tbody id="boardList">
                                <c:forEach var="knowledgeDTO" items="${boardList }">
                                	<tr align="center">
                                		...
                                		<td>${startBoardIdx }</td>
                                		<td align="left">
                                			<a href="${contextPath }/boardAdvance/knowledgeDetail?boardId=${knowledgeDTO.boardId}">${knowledgeDTO.subject }</a>
                                		</td>
                            ...
                            <tr align="right">
                            	<td colspan="6">
                            		<input type="button" value="글쓰기" onclick="location.href='${contextPath}/boardAdvance/knowledgeAddBoard'">
                            	</td>
                            </tr>
                            <tr>
