                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact__content">
                        ...
                        <div class="contact__form">
                            <h5>댓글 삭제</h5>
                            <form action="${contextPath }/boardAdvance/noticeRemoveReply" method="post">
                                <input type="text" name="memberId" id="memberId" placeholder="아이디" value="${noticeReplyDTO.memberId }"  required="required" maxlength="15" readonly="readonly"/>
								...
								<p class="answer"></p>
                                <textarea rows="10" cols="50" name="content" required="required" readonly="readonly">${noticeReplyDTO.content }</textarea>
                                ...
                                <button type="submit" class="site-btn" onclick="location.href='${contextPath}/boardAdvance/noticeDetail?boardId=${noticeReplyDTO.boardId }'">뒤로가기</button>
                            </form>
                        </div>
                         <div>
                         	<br><br>
