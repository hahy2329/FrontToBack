                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact__content">
                        ...
                        <div class="contact__form">
                            <h5>댓글 삭제</h5>
                            <form action="${contextPath }/boardAdvance/bookRemoveReply" method="post">
								...
								<p class="answer"></p>
                                <textarea rows="10" cols="50" name="content" required="required" readonly="readonly">${bookReplyDTO.content }</textarea>
                                ...
                                <button type="submit" class="site-btn" onclick="location.href='${contextPath}/boardAdvance/bookDetail?boardId=${bookReplyDTO.boardId }'">뒤로가기</button>
                            </form>
                        </div>
                         <div>
                         	<br><br>
