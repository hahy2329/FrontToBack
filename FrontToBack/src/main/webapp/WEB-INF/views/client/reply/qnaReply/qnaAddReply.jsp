                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact__content">
                        ...
                        <div class="contact__form">
                            <h5>댓글 작성</h5>
                            <form action="${contextPath }/boardAdvance/qnaAddReply" method="post">
                                ...
                                <button type="submit" class="site-btn" onclick="location.href='${contextPath}/boardAdvance/qnaDetail?boardId=${boardId }'">뒤로가기</button>
                            </form>
                        </div>
                         <div>
                         	<br><br>
