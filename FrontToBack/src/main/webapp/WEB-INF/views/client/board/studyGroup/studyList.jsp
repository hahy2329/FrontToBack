...
<script>
	...
	function getBoardList(){
		...
		var url = "${contextPath}/boardAdvance/studyList";
                ...
                <div class="col-lg-12">
                    ...
                    <h2>스터디 그룹</h2>
                        <table>
                            ...
                            <tbody id="boardList">
                                <c:forEach var="studyDTO" items="${boardList }">
                                	<tr align="center">
                                		<c:set var="startBoardIdx" value="${startBoardIdx + 1 }"/>
                                		<td>${startBoardIdx }</td>
                                		<td align="left">
                                			<a href="${contextPath }/boardAdvance/studyDetail?boardId=${studyDTO.boardId}">${studyDTO.subject }</a>
                                		</td>
                                		<td>${studyDTO.memberId }</td>
                                		<td>${studyDTO.sort }</td>
                                		<td><fmt:formatDate value="${studyDTO.enrollDt }" pattern="yyyy-MM-dd"/></td>
                                		<td>${studyDTO.readCnt }</td>
                                	</tr>
                            ...
                            <tr align="right">
                            	<td colspan="6">
                            		<input type="button" value="글쓰기" onclick="location.href='${contextPath}/boardAdvance/studyAddBoard'">
                            	</td>
                            </tr>
                            <tr>
                        ...
                        <div style="display: table; margin-left: auto; margin-right: auto">
                        	<ul>
                        		<c:if test="${startPage > 10 }">
                        			<li>
                        				<a href="${contextPath }/boardAdvance/studyList?currentPageNumber=${startPage - 10}&onePageViewCnt=${onePageViewCnt }&searchKeyword=${searchKeyword }&searchWord=${searchWord }">이전</a>
                        			</li>
                        		</c:if>
                        		<c:forEach var="i" begin="${startPage }" end="${endPage }">
                        			<li>
                        				<a href="${contextPath }/boardAdvance/studyList?currentPageNumber=${i }&onePageViewCnt=${onePageViewCnt  }&searchKeyword=${searchKeyword }&searchWord=${searchWord}">${i }</a>
                        			</li>
                        		</c:forEach>
