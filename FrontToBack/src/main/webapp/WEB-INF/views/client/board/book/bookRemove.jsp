                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact__content">
                        ...
                        <div class="contact__form">
                            <h5>게시글 삭제</h5>
                            <form action="${contextPath }/boardAdvance/bookRemoveBoard" method="post">
								...
								<p class="answer"></p>
                                <input type="text" name="subject" required="required" placeholder="제목" value="${bookDTO.subject }" readonly="readonly">
                                <textarea rows="10" cols="50"  name="content" required="required" readonly="readonly">${bookDTO.content }</textarea>
