                    ...
                    <div class="contact__content">
                        <div class="contact__form">
                            ...
                            <form action="${contextPath }/boardAdvance/qnaRemoveBoard" method="post">
								...
								<p class="answer"></p>
                                <input type="text" name="subject" required="required" placeholder="제목" value="${qnaDTO.subject }" readonly="readonly">
                                <textarea rows="10" cols="50"  name="content" required="required" readonly="readonly">${qnaDTO.content }</textarea>
