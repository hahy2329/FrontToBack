                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact__content">
                        ...
                        <div class="contact__form">
                            <h5>게시글 작성</h5>
                            <form action="${contextPath }/admin/noticeAddBoard" method="post">
                                <input type="text" name="adminId" id="adminId" value="${sessionScope.adminId }" readonly="readonly" placeholder="아이디">
