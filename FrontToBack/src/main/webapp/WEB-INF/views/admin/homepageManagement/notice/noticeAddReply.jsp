                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact__content">
                        ...
                        <div class="contact__form">
                            <h5>댓글 작성</h5>
                            <form action="${contextPath }/admin/noticeAddReply" method="post">
                                <input type="text" name="adminId" id="adminId" placeholder="아이디" value="${sessionScope.adminId }"  required="required" maxlength="15" readonly="readonly"/>
                                ...
                                <button class="site-btn"><a href="${contextPath}/admin/noticeDetail?boardId=${boardId}" style="color: white;">뒤로가기</a></button>
                            </form>
                        </div>
                         <div>
                         	<br><br>
